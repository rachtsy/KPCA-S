...
for i in {0..0}
  do
    ...
    #  eps=$(perl -e "print $i")
     ...
     --output_dir /home/ubuntu/Kpca/checkpoints/ --use_wandb 1 --project_name 'robust_attack' --job_name sym_6itperlayer1_cw --attack 'cw' --eps 10 \
     --finetune /home/ubuntu/Kpca/checkpoints/rpc/6itperlayer1.pth --eval 1 --robust
done
