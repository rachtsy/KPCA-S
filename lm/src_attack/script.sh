...
# --cuda --data /root/data/wikitext-103/ --dataset wt103 --adaptive \
# --n_layer 16 --d_model 128 --n_head 8 --d_head 16 --d_inner 2048 --dropout 0.1 --dropatt 0.0 --optim adam --lr 0.00025 --warmup_step 2000 \
# --max_step 500000 --attn_type 2 --tgt_len 256 --mem_len 0 --eval_tgt_len 256 --batch_size 96 --multi_gpu --use_wandb --project_name 'lm' \
# --seed 1111 --job_name lm-baseline --work_dir /root/checkpoints/lm 

CUDA_VISIBLE_DEVICES=4,5 python eval_sliding_window.py --cuda --data /root/data/wikitext-103/ \
--dataset wt103 --split 'test' --batch_size 1 --tgt_len 256 --mem_len 0 --clamp_len 256 --work_dir /root/checkpoints/lm/
